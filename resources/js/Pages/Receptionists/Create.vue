...
<template>
    <Head title="Create Receptionist — Grand Horizon" />
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-1">
                        Add a new hotel receptionist to handle client approvals and reservations.
                    </p>
                </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex items-center space-x-5">
                                <div class="relative">
                                    <img
                                        :src="avatarPreview || 'https://ui-avatars.com/api/?name=Receptionist&background=0f172a&color=fff'"
                                        alt="Avatar preview"
                        ...
                        <div class="flex items-center justify-end space-x-3 pt-4 border-t border-slate-200">
                            ...
                            <PrimaryButton :disabled="form.processing">
                                ...
                                <span v-else>Save Receptionist</span>
                            </PrimaryButton>
                        </div>
                    </form>
                </div>
